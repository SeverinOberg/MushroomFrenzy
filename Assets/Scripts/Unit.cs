...
public class Unit : MonoBehaviour
{
    ...
    // Blink X color for Y seconds. Prior color is the color the object was at the time of this function call.
    // If we don't want to return to our prior color, we return to the prefab's default color.
    // This functionality was implemented because of frequent color changing while dragging buildings.
    public void Blink(Color color, float seconds = 0.2f, bool returnToPriorColor = false)
    {
        ...
        {
            spriteRenderer.color = color;
            StartCoroutine(DoSetColorDelay(defaultColor, seconds));
        }
    }
